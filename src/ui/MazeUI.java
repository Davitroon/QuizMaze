...
public class MazeUI {
    ...
    private void initialize() {
        ...
        // Life label
        lifeLabel = new JLabel("Life: " + player.getLife());
        ...
        if (showTimedQuestion()) {
            ...
            if (matrix[targetY][targetX] == 1) { // Medkit
                ...
                if (leftover > 0) {
                    ...
                    JOptionPane.showMessageDialog(frame, "You found a medkit! +" + (medkitLife-leftover) + " life, +" + leftover + " points");
                } else {
                ...
                player.reduceLife(crocodileDamage);
            ...
            if (targetX == width - 1 && targetY == height - 1) { 
                timer.stop();
                JOptionPane.showMessageDialog(frame, "You reached the goal!\nTime: " + timerLabel.getText().replace("Time: ", ""));
                showSummary();
                frame.dispose();
            }
     ...
     * Renders a 3x3 window centered on the player with colors based on maze content.
     */
            ...
            for (int offsetX = -1; offsetX <= 1; offsetX++) {
                ...
                if (x >= 0 && x < width && y >= 0 && y < height) {
                    ...
                    if (x == width - 1 && y == height - 1) {
                        ...
                        switch (element) {
                            case 0: cell.setBackground(Color.WHITE); break;   // Empty
                            case 1: cell.setBackground(Color.GREEN); break;   // Medkit
                            case 2: cell.setBackground(Color.RED); break;     // Crocodile
                            case 3: cell.setBackground(Color.GRAY); break;    // Wall
    ...
    private void updateTimer() {
        ...
        if (min < 10) minStr.append('0');
        minStr.append(min);

        StringBuilder secStr = new StringBuilder();
        if (sec < 10) secStr.append('0');
        secStr.append(sec);
    ...
    private boolean showTimedQuestion() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (userAnswer.equalsIgnoreCase(question.getCorrectAnswer())) {
                    ...
                    if (questionAttempts >= 3) {
                        ...
                        JOptionPane.showMessageDialog(questionDialog, "Incorrect answer. Attempt " + questionAttempts + " of 3.");
                    }
                }
            }
        });
        ...
        if (questionResult) {
            ...
            incorrectAnswers++;
            player.reduceLife(questionDamage); 
            JOptionPane.showMessageDialog(frame, "Too many wrong answers or time ran out! You lose " + questionDamage + " life.");
            updateView();
        }
    ...
    private void showSummary() {
        ...
        boolean victory = player.getLife() > 0;
        ...
        // Open results window
        ResultsMazeUI resultsWindow = new ResultsMazeUI(
            player.getName(),    // username
            correctAnswers,      // correctAnswers
            incorrectAnswers,    // incorrectAnswers
            player.getLife(),    // finalLife
